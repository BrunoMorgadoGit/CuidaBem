...
async function bootstrap(): Promise<void> {
  ...
  const server = app.listen(env.PORT, () => {
    ...
    console.log(`║  Ambiente:    ${env.NODE_ENV.padEnd(42)}║`);
    console.log(`║  CORS:        ${env.CORS_ORIGINS.slice(0, 42).padEnd(42)}║`);
    console.log(`║  JWT Expiry:  ${env.JWT_EXPIRES_IN.padEnd(42)}║`);
    console.log(`║  Uploads:     ${env.UPLOAD_DIR.padEnd(42)}║`);
    console.log('╠══════════════════════════════════════════════════════════╣');
    ...
    console.log('║   GET    /api/educational/violence-types                 ║');
    console.log('║   GET    /api/educational/emergency-contacts             ║');
    console.log('║   POST   /api/health/observations/analyze               ║');
    console.log('║   GET    /api/patients/:id/dashboard                     ║');
    console.log('╚══════════════════════════════════════════════════════════╝\n');
  });
